...
public class DBHelper extends SQLiteOpenHelper {
    ...
    /*
    public boolean getDataSearchh(String text){
    ...
    */
    ...
    /*
    public List<Student> getAllcontactDetailsForSearch(String Text) {

        List<Student> contactList = new ArrayList<Student>();

        String selectQuery = "select * from contacts where name like %"+Text+"%";
